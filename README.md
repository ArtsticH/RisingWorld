...
此仓库是 **RisingWorld** 游戏的插件集合库，旨在为玩家和爱好者增强游戏体验。
This repository is a curated collection of plugins for the game **RisingWorld**, designed for players and enthusiasts to enhance their gaming experience.

> **注意**：本项目由 [ArtsticH](https://github.com/ArtsticH) **独立维护**，是社区驱动的项目。与官方网站 [www.rising-world.net](https://www.rising-world.net) 无关，但我们欢迎官方的认可或收录。
...
1.  **通过Steam找到你的RisingWorld游戏根目录 / Navigate to your RisingWorld game directory via Steam:**
...
2.  **在游戏根目录打开终端（命令提示符/PowerShell），运行以下命令：**
    In the game's root directory, open a terminal (Command Prompt/PowerShell) and run:
    ```bash
...
4.  **通过Steam正常启动RisingWorld游戏即可。 / Launch RisingWorld normally through Steam.**
...
1.  **按照方式一的步骤1，打开你的RisingWorld游戏根目录。**
...
2.  **以ZIP格式下载本仓库： / Download the repository as a ZIP file:**
    - 点击本GitHub页面的绿色 **Code** 按钮。 / Click the green **Code** button on this GitHub page.
...
3.  **解压下载好的ZIP文件，复制其中的四个主要文件/文件夹**。
    Extract the downloaded ZIP file. Copy the **four main files/folders** from inside.

    ![解压并复制文件](https://raw.githubusercontent.com/ArtsticH/h-Readme-res/main/RisingWorld/doc/images/h1_Git-zip-ext.webp)

4.  **将复制的文件粘贴到游戏根目录。然后双击运行汉化脚本：**
    Paste the copied files into the game's root directory. Then, double-click the localization script:
    `!H一键汉化(ToChinese).bat`
...
- **最新适配**：已测试并适配 **RisingWorld 0.9.1** 版本
  **Latest Compatibility**: Tested and adapted for **RisingWorld 0.9.1**
- **项目状态**：由开发者个人积极维护中。
  **Project Status**: Actively maintained by a single developer.
- **反馈与贡献**：欢迎通过 [GitHub Issues](https://github.com/ArtsticH/RisingWorld/issues) 页面提交建议或报告问题。
  **Contributions & Feedback**: Suggestions and issue reports are welcome via the [GitHub Issues](https://github.com/ArtsticH/RisingWorld/issues) page.

---

## 🔗 相关链接 / Related Links

- [RisingWorld 官方网站](https://www.rising-world.net)
  [RisingWorld Official Website](https://www.rising-world.net)
- [RisingWorld Steam页面](https://store.steampowered.com/app/324080/RisingWorld/)
  [RisingWorld on Steam](https://store.steampowered.com/app/324080/RisingWorld/)
