...
If Not Objet.FileExists("Data\StreamingAssets\Languages\zh.json") Then MsgBox "尚未汉化，无需恢复", 48, "RisingWorld 设计师汉化包" : WScript.Quit
...
On Error Goto 0
MsgBox "现已重置为官方原版英语！"& vbcrlf &"如需再次汉化，请运行！H一键汉化(ToChinese).bat"& vbcrlf &"　　　　　　　　　——by ArtsticH（抖音@跑偏了的设计师|航拍调色）", 48, "RisingWorld 设计师汉化包"
